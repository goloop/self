...
Зверніть увагу: `UnmarshalStrict`, а не `Unmarshal`. Поблажлива форма пропускає
ключі, яких структура не знає - це правильно для документа, що його читають
кілька версій програми, і неправильно для файлу, який людина веде руками, де
невідомий ключ майже завжди є одруківкою у відомому:
...
- Налаштуванням зі структурою місце у YAML-файлі, а не у змінній: читайте його
  через `yaml.UnmarshalStrict`, щоб одруківка в ключі була помилкою з номером
  рядка, а не конфігом, який мовчки втратив половину себе.
