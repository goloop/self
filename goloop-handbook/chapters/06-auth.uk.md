...
Про перетворення цього на продакшн-вхід - перевірки ключа на старті, обмеження
частоти, бюджет пам'яті Argon2id, таймінг-безпечну обробку відсутнього акаунта -
див. [Вхід, який переживе продакшн](11-hardened-signin.uk.md); про повний
життєвий цикл refresh-токена - [Життєвий цикл refresh-токена](12-refresh-lifecycle.uk.md),
обидва в Частині IV.
